...
function hentDataAdmin(type = 0) {
    ...
    // if (type > 0) url += '/' + type;
    fetch('http://178.62.227.144:3001/produkter', {
        'method': 'GET',
        'mode':'cors',
        'cache': 'default'
    })
            ...
            data.forEach(function (item) {
                ...
                <table style="width:100%">
                  ...
                  <tr>
                    ...
                    <td><img src="http://178.62.227.144:3001/images/${item.billede}"></td>
        ...
        .then((data) => {
            ...
            data.forEach(function (item) {
                ...
                <p>Beskrivelse: ${item.beskrivelse}</p>
                    ...
                    <select required name="select1" id="opdaterfk_kategori_id" class="col-md-4 col-md-offset-4">
                <option>Vælg kategori</option>
                    ...
                    <select required name="select2" id="opdaterfk_producent" class="col-md-4 col-md-offset-4">
...
function sletProdukt(id) {
    ...
    let url = 'http://178.62.227.144:3001/produkt'; // API'et/routet, det som der står i URL'en i browseren
    if (id != undefined) {
        url += '/' + id;
    }
    console.log(url);
