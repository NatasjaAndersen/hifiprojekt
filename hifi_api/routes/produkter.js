...
module.exports = function (app) {
    ...
    app.post('/oprett', security.isAuthenticated, (req, res, next) => { // Route som uploader billeder 
                ...
                let fk_kategori = req.body.fk_kategori_id;
                ...
                if (name != '' && beskrivelse != '' && !isNaN(pris)) {
                    ...
                    console.log(name, pris, beskrivelse, fk_kategori_id, fk_producent, image);
                    db.query(sql, [name, pris, beskrivelse, fk_kategori_id, fk_producent, image], function (err, data) {
                        if (err) {
                            console.log(err);
                        } else {
                            res.json(200, data);
